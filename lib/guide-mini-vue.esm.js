...
function createRenderer(options) {
    ...
    function patchChildren(prevNode, currNode, el, parent) {
        ...
        if (prevNodeShape & 8 /* SHAPEFLAG.ARRAY_CHILDREN */ &&
            currNodeShape & 4 /* SHAPEFLAG.TEXT_CHILDREN */) {
            unmountChildren(oldChildren);
            hostSetElementText(newChildren, el);
            return;
        }
        if (prevNodeShape & 4 /* SHAPEFLAG.TEXT_CHILDREN */ &&
            currNodeShape & 4 /* SHAPEFLAG.TEXT_CHILDREN */) {
        ...
        if (prevNodeShape & 4 /* SHAPEFLAG.TEXT_CHILDREN */ &&
            currNodeShape & 8 /* SHAPEFLAG.ARRAY_CHILDREN */) {
